...
$sql = $conn->prepare("SELECT * FROM tbl_rescue WHERE res_id = '$id' AND is_deleted != '1'");
$sql->execute();
if($sql->rowCount() > 0)
{
	$sql_data = $sql->fetch();
...
?>
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="date" class="form-control" id="exampleInputuname" placeholder="Date" name="ph_date_incident" value="<?php echo $sql_data['ph_date_incident']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="time" class="form-control" id="exampleInputuname" placeholder="Time Incident" name="ph_time_incident" value="<?php echo $time_incident_formatted; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Patient's Name" name="ph_name" value="<?php echo $sql_data['ph_name']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Patient's Age" name="ph_age" value="<?php echo $sql_data['ph_age']; ?>" autocomplete=off /> </div>
					</div>
				</div>
					...
					<div class="col-sm-9">
						<div class="input-group">														
							<select name="ph_gender" class="thor" style="width:fit-content;">
								<option value="<?php echo $sql_data['ph_gender']; ?>"><?php echo $sql_data['ph_gender']; ?></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Patient's Contact No" name="ph_contact" value="<?php echo $sql_data['ph_contact']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Patient's Address" name="ph_address" value="<?php echo $sql_data['ph_address']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-home"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Incident Case" name="ph_case" value="<?php echo $sql_data['ph_case']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-clock"></i></div>
							<input type="time" class="form-control" id="exampleInputuname" placeholder="Time Reported" name="ph_time_report" value="<?php echo $time_report_formatted; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-clock"></i></div>
							<input type="time" class="form-control" id="exampleInputuname" placeholder="Time of Arrival" name="ph_time_arrival" value="<?php echo $time_arrival_formatted; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Location of Incident" name="ph_location_incident" value="<?php echo $sql_data['ph_location_incident']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<hr />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-calender"></i></div>
								<input type="date" class="form-control" id="exampleInputuname" placeholder="vaccination date" name="pa_vacs_date" value="<?php echo $sql_data['pa_vacs_date']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Complaint" name="pa_complaint" value="<?php echo $sql_data['pa_complaint']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Allergy" name="pa_allergy" value="<?php echo $sql_data['pa_allergy']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Medication" name="pa_medication" value="<?php echo $sql_data['pa_medication']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Past Hx" name="pa_past_hx" value="<?php echo $sql_data['pa_past_hx']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Last Meal" name="pa_last_meal" value="<?php echo $sql_data['pa_last_meal']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Events Prior" name="pa_events_prior" value="<?php echo $sql_data['pa_events_prior']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Onset" name="pa_onset" value="<?php echo $sql_data['pa_onset']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Palliation" name="pa_palliation" value="<?php echo $sql_data['pa_palliation']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Quality" name="pa_quality" value="<?php echo $sql_data['pa_quality']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Radiation" name="pa_radiation" value="<?php echo $sql_data['pa_radiation']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Severity" name="pa_severity" value="<?php echo $sql_data['pa_severity']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-clock"></i></div>
								<input type="time" class="form-control" id="exampleInputuname" placeholder="Time" name="pa_time" value="<?php echo $pa_time_formatted; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="OTHER MNGT/ASSESSMENT" name="pa_other" value="<?php echo $sql_data['pa_other']; ?>" autocomplete=off /></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">														
								...
								<input type="text" class="form-control" id="a" placeholder="a" name="pa_o2_a" value="<?php echo $sql_data['o2_value']; ?>" style="display:none;margin-top:3px;" autocomplete=off />
								<input type="text" class="form-control" id="via" placeholder="Via" name="pa_o2_via" value="<?php echo $sql_data['o2_via']; ?>" style="display:none;margin-top:3px;" autocomplete=off />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">														
								...
								<input type="text" class="form-control" id="meds2" placeholder="Med Given" name="med_given" value="<?php echo $sql_data['med_given']; ?>" style="display:none;margin-top:3px;" autocomplete=off />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">														
								...
								<input type="text" class="form-control" id="bs_ml" placeholder="mg/dl" name="bs_ml" value="<?php echo $sql_data['bloods_mg_dl']; ?>" style="display:none;margin-top:3px;" autocomplete=off />
							</div>
						</div>
					</div>
		...
		<div class="col-md-6"><!--PA LVL CONSCIOUSNESS START-->
			...
			<h3 style="color:#663399; font-weight:bold;">Patient Assessment</h3><h6 style="color:#663399; font-weight:bold;">Level of Consciousness</h6>
				...
				<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">														
								<select name="pa_option1" class="csi" style="width:100px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">														
								<select name="pa_option2" class="csi" style="width:100px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="BP" name="pa_on_bp" value="<?php echo $sql_data['pa_on_bp']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="PR" name="pa_on_pr" value="<?php echo $sql_data['pa_on_pr']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="RR" name="pa_on_rr" value="<?php echo $sql_data['pa_on_rr']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="TEMP" name="pa_on_temp" value="<?php echo $sql_data['pa_on_temp']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="spo2" name="pa_on_spo2" value="<?php echo $sql_data['pa_on_spo2']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="BP" name="pa_in_bp" value="<?php echo $sql_data['pa_in_bp']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="PR" name="pa_in_pr" value="<?php echo $sql_data['pa_in_pr']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="RR" name="pa_in_rr" value="<?php echo $sql_data['pa_in_rr']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="TEMP" name="pa_in_temp" value="<?php echo $sql_data['pa_in_temp']; ?>" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="spo2" name="pa_in_spo2" value="<?php echo $sql_data['pa_in_spo2']; ?>" autocomplete=off /> </div>
						</div>
					</div>
			</div>
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="LMP" name="ob_lmp" value="<?php echo $sql_data['ob_lmp']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="EDC" name="ob_edc" value="<?php echo $sql_data['ob_edc']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="G" name="ob_g" value="<?php echo $sql_data['ob_g']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="P" name="ob_p" value="<?php echo $sql_data['ob_p1']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="AOG WEEKS" name="ob_aog_wks" value="<?php echo $sql_data['ob_aog_wks']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="AOG DAYS" name="ob_aog_days" value="<?php echo $sql_data['ob_aog_day']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="T" name="ob_t" value="<?php echo $sql_data['ob_t']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="P" name="ob_p2" value="<?php echo $sql_data['ob_p2']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="A" name="ob_a" value="<?php echo $sql_data['ob_a']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="L" name="ob_l" value="<?php echo $sql_data['ob_l']; ?>" autocomplete=off /> </div>
					</div>
				</div>
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="time" class="form-control" id="exampleInputuname" placeholder="" name="nb_time" value="<?php echo $nb_time_formatted; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Placenta" name="nb_placenta" value="<?php echo $sql_data['nb_placenta']; ?>" autocomplete=off /> </div>
					</div>
				</div>
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="1 MIN" name="as_1min" value="<?php echo $sql_data['as_1min']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="5 MINS" name="as_5min" value="<?php echo $sql_data['as_5min']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="10 MINS" name="as_10min" value="<?php echo $sql_data['as_10min']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Receiving Facility" name="as_rec_fac" value="<?php echo $sql_data['receiving_facility']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Team Leader" name="as_receiving" value="<?php echo $sql_data['receiver']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Team Leader" name="as_team_lead" value="<?php echo $sql_data['team_leader']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Driver" name="as_driver" value="<?php echo $sql_data['driver']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Rescuer/s" name="as_rescuers" value="<?php echo $sql_data['rescuers']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Accomplished By" name="as_acc_by" value="<?php echo $sql_data['accomplished_by']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Encoded By" name="as_enc_by" value="<?php echo $sql_data['encoded_by']; ?>" autocomplete=off /> </div>
					</div>
				</div>
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Witnessed" name="witness" value="<?php echo $sql_data['rot_witness']; ?>" autocomplete=off /> </div>
					</div>
				</div>
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Name of Patient/Relative" name="patient_rela" value="<?php echo $sql_data['aos_name']; ?>" autocomplete=off /> </div>
					</div>
				</div>
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Hospital" name="hospital" value="<?php echo $sql_data['ect_hospital_name']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Name of Doctor" name="doctor_name" value="<?php echo $sql_data['ect_doctor_name']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Doctor's Address" name="doctor_address" value="<?php echo $sql_data['ect_doctor_address']; ?>" autocomplete=off /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Name" name="ect_name" value="<?php echo $sql_data['ect_requestor_name']; ?>" autocomplete=off /> </div>
					</div>
				</div>
	...
	<script>
			...
			if(med_given_checker == "Yes"){
				...
				document.getElementById("meds2").value = "";
			}
			...
			if(blood_sug_checker == "Yes"){
				...
				document.getElementById("bs_ml").value = "";
			}
	</script>
<?php
	}else{
