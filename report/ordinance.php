...
<body onload="window.print();" style="background: url(../images/bmis_standard_head_big.png); background-repeat: no-repeat; background-size: 100% 25%;">
		...
		<tr>		
			<td style="text-align:center;">
				<h3>Barangay Ordinance Report</h3>				
			</td>
		</tr>
		<table>
		...
		<tr><td>		
			...
			<tr>
				...
				<td width="20px;">&nbsp;</td>
				<td class="tdlabel" style="width:150px;">Ordinance No.</td>				
				<td width="20px;">&nbsp;</td>				
				<td class="tdlabel" style="width:500px;">Title</td>
				<td width="20px;">&nbsp;</td>								
			...
			<tr>
				<td colspan="20"><hr color='black' /></td>
								  ...
								  <tbody>
									<?php
										$ord = $conn->prepare("SELECT * FROM tbl_ordinance
															WHERE (ord_date BETWEEN '$newfrom' and '$newto') AND is_deleted != '1'
																ORDER BY ord_date");
										$ord->execute();
										$ctr1 = 1;
										while($ord_data = $ord->fetch())
										{
												$date = date("M d, Y", strtotime($ord_data['ord_date']));
												
									?>
												<tr>
													<td class="tddata" valign="top"><?php echo $ctr1++; ?>. </td>
													<td width="20px;">&nbsp;</td>													
													<td class="tddata" valign="top"><?php echo $ord_data['ord_itemno']; ?></td>													
													<td width="20px;">&nbsp;</td>													
													<td class="tddata" valign="top" style="width:150px;"><?php echo $ord_data['ord_no']; ?></td>													
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top" style="width:500px;"><?php echo $ord_data['ord_title']; ?></td>
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top" style="width:100px;"><?php echo $date; ?></td>
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top"><?php echo $ord_data['ord_committee']; ?></td>
												</tr>
									<?php
										} // End While
									?>
