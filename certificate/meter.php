...
.box1{
	...
	<div class="divBody">
		...
		<div class="divBody2">
			...
			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Barangay Novaliches Proper interposes no objection to the application of <b><?php echo $sql_data['firstname']; ?> 
				<?php echo $sql_data['middlename']; ?><span id="suffix"></span></b> for a <b><?php echo $sql_data['installation_type']; ?></b> installation of 
				<b>(<?php echo $sql_data['provider']; ?>)</b> located at <b><?php echo $sql_data['address']; ?></b>, Barangay Novaliches Proper, District V, Quezon City. 
				Provided, that all necessary permits and clearances will be secured and all existing laws and ordinances will not be violated.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Provided further, that the excavated area will be restored to its original status by the requesting party. This is subject for cancellation and 
				revocation should the requesting party violated existing laws; rules & regulations being implemented by the government.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Issued this <b><?php echo $day_issued; ?></b> day of <b><?php echo $month_issued; ?> <?php echo $year_issued; ?></b> at the 
			Barangay Multi-Purpose Hall, Buenamar Street, Buenamar Subdivision, Novaliches Proper, District V, Quezon City.</p></center>
		...
		<p style="font-size: 9px; margin-left:6%; margin-top: 6%; position:absolute;">Note: <span style="font-style:italic;">This certification is valid only for one (1) year from the date issued.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Not valid without an official dry seal. Not valid if with erasure.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/HBC 01-2023</span></p>
