...
<html>
<head>
<title>Terminal Clearance</title>
	<meta charset="utf-8">
...
.box1{
	...
	<div class="divBody">
		...
		<div class="divBody2">
			...
			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Barangay Novaliches Proper, Quezon City, interposes no objection to the application of 
				<b><?php echo $sql_data['toda']; ?></b> for a <b><?php echo $sql_data['purpose']; ?></b> located at <b><?php echo $sql_data['toda_address']; ?></b>, Barangay 
				Novaliches Proper, District V, Quezon City. Provided, that all necessary permits and clearances will be secured and all existing laws and ordinances will not 
				be violated.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Provided further, the said terminal is not a nuisance and will not cause vehicular and 
				pedestrian traffic in the area.</p></center>
