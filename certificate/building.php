	...
	<div class="divBody">
		...
		<div class="divBody2">
			...
			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Barangay Novaliches Proper, Quezon City, interposes no objection for the application of 
				<b><?php echo $sql_data['firstname']; ?> <?php echo $sql_data['middlename']; ?> <?php echo $sql_data['lastname']; ?><span id="suffix"></span></b> to construct 
				a <b><?php echo $sql_data['build_detail']; ?></b> located at <b><?php echo $sql_data['build_address']; ?></b>, Barangay Novaliches Proper, Quezon City.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Provided, that the necessary permit shall be secured. All laws, rules, and regulations shall be followed and the contractor shall ensure the safety 
				of passersby and the general public.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Provided further, that the abovementioned construction is not intended to eject tenants and will not violate the rights of other lot or 
				house owners of adjacent lots.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Provided further that the contractor and owner shall ensure the smooth flow of traffic in the area.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This certification is being issued upon the request of <b><?php echo $sql_data['firstname']; ?> 
				<?php echo $sql_data['middlename']; ?> <?php echo $sql_data['lastname']; ?><span id="suffix2"></span></b> as requirement for the issuance of a <b>BUILDING PERMIT</b> by 
				the Quezon City government.</p></center>
		...
		<p style="font-size: 9px; margin-left:6%; margin-top: 6%; position:absolute;">Note: <span style="font-style:italic;">This certification is valid only for one (1) year from the date issued.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Not valid without official dry seal. Not valid if with erasures.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/HBC 01-2023</span></p>
