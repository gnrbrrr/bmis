...
#tdata{
	...
	<div class="divBody">
		...
		<div class="divBody2">
			...
			<table style="font-family:cambria; font-size:14px; position:absolute; margin-top: -2%;">
				<tr>
					<td style="color:#000080;"><b>HON. OLIVIERE T. BELMONTE</b></td>
				</tr>
				<tr>
					<td>Chairman</td>
				</tr>
				<tr>
					<td>Tricycle Franchising Board (TFB)</td>
				</tr>
				<tr>
					<td>Quezon City</td>
				</tr>
			...
			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <b><?php echo $sql_data['firstname']; ?> 
				<?php echo $sql_data['middlename']; ?> <?php echo $sql_data['lastname']; ?><span id="suffix"></span></b> with a postal address located at 
				<b><?php echo $sql_data['address']; ?></b>, is as a legitimate owner and operator of a tricycle unit described below:</p></center>
			...
			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This office interposes no objection to the <b>application</b> for the <b>franchise 
				(NEW/RENEWAL)</b> of the applicant to operate the MOTORIZED TRICYCLE, herein described, within the Barangay and neighboring Barangay subject to the provisions 
				of the Quezon City Tricycle Ordinance of 1992 and its Implementing Guidelines/Rules.</p></center>
		...
		<p style="font-size: 9px; margin-left:6%; margin-top: 12%; position:absolute;">Note: <span style="font-style:italic;">Valid up to one (1) year from the date issued.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Not valid without a dry seal. Not valid if with erasure.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/HBC 01-2023</span></p>

		<br />
		<table style="margin-left:6%; margin-top:14%; position:absolute;">
			<tr>
				<td style="width: 250px">
...
<script>
	...
	if(person_signing != "none"){
		...
		document.getElementById("officials").style.marginTop = "-6%";
