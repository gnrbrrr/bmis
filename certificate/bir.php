...
require_once '../include/functions.php';
	...
	$day_death = date("d", strtotime($sql_data['date_death']));
	$month_death = date("F", strtotime($sql_data['date_death']));
	$year_death = date("Y", strtotime($sql_data['date_death']));
...
.box1{
	...
	<div class="divBody">
		...
		<div class="divBody2">
			...
			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <b><?php echo $sql_data['firstname']; ?> <?php echo $sql_data['middlename']; ?> 
				<?php echo $sql_data['lastname']; ?><span id="suffix"></span></b>, <b><?php echo $sql_data['relationship']; ?></b> to the <b><?php echo $sql_data['deceased_name']; ?></b>, passed away 
				last <b><?php echo $month_death; ?> <?php echo $day_death; ?>, <?php echo $year_death; ?></b> is a resident of this barangay with postal address at 
				<?php echo $sql_data['address']; ?>.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This certifies further that the above-mentioned name was the rightful person to take care of the paperwork’s 
				instruments pertaining to matters of <b><?php echo $sql_data['purpose']; ?></b>.</p></center>

			<center><p class="p1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This certification is being issued upon the request of <b><?php echo $sql_data['firstname']; ?> <?php echo $sql_data['middlename']; ?> <?php echo $sql_data['lastname']; ?><span id="suffix2"></span></b></p></center>

			<center><p class="p2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Issued this <b><?php echo $day_issued; ?></b> day of <b><?php echo $month_issued; ?> <?php echo $year_issued; ?></b> at the 
