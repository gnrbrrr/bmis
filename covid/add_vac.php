			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Vaccine Brand Name" name="brand" autocomplete=off required /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="date" class="form-control" id="exampleInputuname" placeholder="" name="date_taken" autocomplete=off required /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<textarea class="form-control" id="exampleInputuname" placeholder="" name="location" style="resize:vertical; min-height:60px; max-height:100px;" autocomplete=off required ></textarea> </div>
					</div>
				</div>
