...
?>
	<div class="row">
	<form class="form-horizontal" method="post" action="process.php?action=modify_vac" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-6">
			<div class="white-box">
			...
			<div class="white-box">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Vaccine Brand Name" name="brand" value="<?php echo $sql_data['brand']; ?>" autocomplete=off required /> </div>
					</div>
				</div>
					...
					<div class="col-sm-9">
						<div class="input-group">
							<select name="dosage" id="dosage">
								<option value="<?php echo $sql_data['dosage']; ?>"><?php echo $sql_data['dosage']; ?></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="date" class="form-control" id="exampleInputuname" placeholder="" name="date_taken" value="<?php echo $sql_data['date_taken']; ?>" autocomplete=off required /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<textarea class="form-control" id="exampleInputuname" placeholder="" name="location" style="resize:vertical; min-height:60px; max-height:100px;" autocomplete=off required ><?php echo $sql_data['location']; ?></textarea> </div>
					</div>
				</div>
