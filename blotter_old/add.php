				...
				<p class="text-muted m-b-30 font-13"> Add Blotter </p>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Blotter No." name="blotterno" autocomplete=off required /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Victim" name="victim" autocomplete=off /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="First Name" name="fsuspect" autocomplete=off required /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Last Name" name="lsuspect" autocomplete=off required /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Middle Name" name="msuspect" autocomplete=off required /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Witness" name="witness1" autocomplete=off /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Witness" name="witness2" autocomplete=off /> </div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="time" class="form-control" id="exampleInputuname" placeholder="Time of Occurence" name="timeofoccurence" autocomplete=off /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="date" class="form-control" id="exampleInputuname" placeholder="Date of Occurence" name="dateofoccurence" autocomplete=off /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Place of Occurence" name="placeofoccurence" autocomplete=off /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<textarea type="text" class="form-control" id="exampleInputuname" placeholder="Narrative" name="narrative" autocomplete=off ></textarea> </div>
						</div>
					</div>
					
					<div class="form-group">
						<label for="exampleInputuname" class="col-sm-3 control-label">Date filed</label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="date" class="form-control" id="exampleInputuname" placeholder="Date filed" name="datefile" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-location-pin"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Articles Involved" name="articles" autocomplete=off /> </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-location-pin"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Disposition" name="disposition" autocomplete=off /> </div>
						</div>
					</div>
