...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_working" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12">
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">CTC No. : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="ctcno" value="<?php echo $sql_data['ctc_num']; ?>" autocomplete=off required /></p>
				</div>
