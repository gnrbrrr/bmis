		...
		<div class="col-md-12">
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">Deceased's Name : </b>
					<p style="padding-left:27px;"><?php echo $sql_data['deceased_name']; ?></p>
				</div>

				<div class="m-l-40"><b class="text-info">Relationship : </b>
					<p style="padding-left:27px;"><?php echo $sql_data['relationship']; ?></p>
				</div>

				<div class="m-l-40"><b class="text-info">Date of Death : </b>
					<p style="padding-left:27px;"><?php echo $ddeath; ?></p>
				</div>
