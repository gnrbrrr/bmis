...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_terminal" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12"> <!--PRE HOSPITAL START-->
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">Name of Association : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="assoc_name" value="<?php echo $sql_data['toda']; ?>" autocomplete=off required /></p>
				</div>

				<div class="m-l-40"><b class="text-info">Association Address : </b>
					<p style="padding-left:27px;"><textarea class="txt_bx" id="exampleInputuname" name="assoc_address" style="resize:vertical; width:400px; min-height:60px; max-height:150px;" autocomplete=off required ><?php echo $sql_data['toda_address']; ?></textarea></p>
				</div>

				<div class="m-l-40"><b class="text-info">Purpose : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="purpose" style="width:300px;" value="<?php echo $purpose; ?>" autocomplete=off required /></p>
				</div>
