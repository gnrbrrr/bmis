		...
		<div class="col-md-12">
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">Meter Type : </b>
					<p style="padding-left:27px;"><?php echo $sql_data['provider']; ?></p>
				</div>

				<div class="m-l-40"><b class="text-info">Installation Type : </b>
					<p style="padding-left:27px;"><?php echo $sql_data['installation_type']; ?></p>
				</div>

				<div class="m-l-40"><b class="text-info">Property Type : </b>
					<p style="padding-left:27px;"><?php echo $sql_data['property_type']; ?></p>
				</div>
