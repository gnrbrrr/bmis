...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_excavation" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12">
			<div class="white-box">
				...
				<div class="m-l-40"><b class="text-info">requestor's Address : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="req_address" value="<?php echo $sql_data['requestor_address']; ?>" autocomplete=off required /></p>
				</div>
				...
				<div class="m-l-40"><b class="text-info">Job No. : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="jobno" value="<?php echo $sql_data['job_no']; ?>" autocomplete=off required /></p>
				</div>
