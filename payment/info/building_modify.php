...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_building" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12"> <!--PRE HOSPITAL START-->
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">Building Details : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="build_det" value="<?php echo $sql_data['build_detail']; ?>" autocomplete=off required /></p>
				</div>

				<div class="m-l-40"><b class="text-info">Building Address : </b>
					<p style="padding-left:27px;"><textarea class="txt_bx" id="exampleInputuname" name="build_address" style="resize:vertical; width:400px; min-height:60px; max-height:150px;" autocomplete=off required ><?php echo $sql_data['build_address']; ?></textarea></p>
				</div>
