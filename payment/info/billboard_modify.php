...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_billboard" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12"> <!--PRE HOSPITAL START-->
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">Type : </b>
					<p style="padding-left:27px;"><select class="text_bx" id="exampleInputuname" name="type">
						<option value="<?php echo $sql_data['type']; ?>"><?php echo $sql_data['type']; ?></option>
						<option value="SIGNAGE">Signage</option>
						<option value="BILLBOARD">Billboard</option>
					</select></p>
				</div>

				<div class="m-l-40"><b class="text-info">Faced : </b>
					<p style="padding-left:27px;"><select class="text_bx" id="exampleInputuname" name="faced">
						<option value="<?php echo $sql_data['faced']; ?>"><?php echo $sql_data['faced']; ?></option>
