...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_bir" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12">
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">Deceased's Name : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="dname" value="<?php echo $sql_data['deceased_name']; ?>" autocomplete=off required /></p>
				</div>

				<div class="m-l-40"><b class="text-info">Relationship : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="relationship" value="<?php echo $sql_data['relationship']; ?>" autocomplete=off required /></p>
				</div>

				<div class="m-l-40"><b class="text-info">Date of Death : </b>
					<p style="padding-left:27px;"><input type="date" class="txt_bx" id="exampleInputuname" name="dtdeath" value="<?php echo $sql_data['date_death']; ?>" autocomplete=off required /></p>
				</div>
