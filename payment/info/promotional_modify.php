...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_promotional" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12"> <!--PRE HOSPITAL START-->
			<div class="white-box">
				<div class="m-l-40"><b class="text-info">Event : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="event" value="<?php echo $sql_data['event']; ?>" autocomplete=off required /></p>
				</div>

				<div class="m-l-40"><b class="text-info">Location : </b>
					<p style="padding-left:27px;"><textarea class="txt_bx" id="exampleInputuname" style="resize:vertical; width:400px; min-height:60px; max-height:150px;" name="event_address" autocomplete=off required ><?php echo $sql_data['event_address']; ?></textarea></p>
				</div>

				<div class="m-l-40"><b class="text-info">Duration : </b>
					<p style="padding-left:27px;"><input type="date" class="txt_bx" id="exampleInputuname" name="duration1" value="<?php echo $sql_data['duration1']; ?>" autocomplete=off required /> To <input type="date" class="txt_bx" id="exampleInputuname" name="duration2" value="<?php echo $sql_data['duration2']; ?>" autocomplete=off required /></p>
				</div>

				<div class="m-l-40"><b class="text-info">Time : </b>
					<p style="padding-left:27px;"><input type="time" class="txt_bx" id="exampleInputuname" name="time1" value="<?php echo $time1_formatted; ?>" autocomplete=off required /> To <input type="time" class="txt_bx" id="exampleInputuname" name="time2" value="<?php echo $time2_formatted; ?>" autocomplete=off required /></p>
				</div>
