...
?>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify_miscellaneous" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12"> <!--PRE HOSPITAL START-->
			<div class="white-box">
				...
				<div class="m-l-40"><b class="text-info">Control No. : </b>
					<p style="padding-left:27px;"><input type="text" class="txt_bx" id="exampleInputuname" name="control" value="<?php echo $sql_data['control_no']; ?>" autocomplete=off required /></p>
				</div>
