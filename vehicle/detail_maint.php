...
<br>
	<div class="row">
	<form class="form-horizontal" method="post" action="process.php?action=add_maint" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-6">
			<div class="white-box">
			...
			<div class="white-box">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="date" class="form-control" id="exampleInputuname" placeholder="Date" name="date_maintenance" autocomplete=off value="<?php echo $sql_data['date_maintenance']; ?>" readonly /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="exampleInputuname" placeholder="ODO Meter Reading" name="odo_read" autocomplete=off value="<?php echo $sql_data['odo_reading']; ?>" readonly /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Corrective Maintenance" name="correct_maint" autocomplete=off value="<?php echo $sql_data['corrective_maint']; ?>" readonly /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Preventive Maintenance" name="prevent_maint" autocomplete=off value="<?php echo $sql_data['preventive_maint']; ?>" readonly /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Predictive Maintenance" name="predict_maint" autocomplete=off value="<?php echo $sql_data['predictive_maint']; ?>" readonly /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<input type="text" class="form-control" id="exampleInputuname" placeholder="Expenses" name="expenses" autocomplete=off value="<?php echo $sql_data['expenses']; ?>" readonly /> </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
							<textarea class="form-control" id="exampleInputuname" placeholder="Remarks" name="remarks" style="resize:vertical; width:430px; min-height:60px; max-height:100px;" autocomplete=off readonly ><?php echo $sql_data['remarks_maint']; ?></textarea> </div>
					</div>
				</div>
