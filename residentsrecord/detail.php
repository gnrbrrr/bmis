...
if (!defined('WEB_ROOT')) {
	...
	$firstname = $sql_data['firstname'];
	$middlename = $sql_data['middlename'];
	$lastname = $sql_data['lastname'];
                        ...
                        <div class="white-box">
                            <div class="profile-widget">
                                ...
                                <div class="profile-detail font-15">
                                    <p><?php echo $sql_data['house_num']; ?><br /><?php echo $sql_data['unit_name']; ?><br /><?php echo $sql_data['street_name']; ?><br /><?php echo $sql_data['purok']; ?><br /><?php echo $sql_data['area_village']; ?><br /><?php echo $sql_data['barangay']; ?><br /><?php echo $sql_data['city_municipality']; ?></p>
				...
				<div class="white-box">
					...
					<div class="form-group m-b-0">
						<div class="col-sm-offset-3 col-sm-9">
							...
							<a type="button" class="btn btn-info waves-effect waves-light pull-left" href="index.php"><i class="ti-back-left me-1"></i> Go Back</a>
