			...
			<div class="white-box">
				<table style="font-size:14px;" cellpadding="17" cellspacing="17">					
					<tbody>
						...
						<tr>
							<td class="th">Still Working</td>
							<td class="th">:</td>
							<td class="td"><?php if($sql_data['is_sc_working'] == 1){ echo "Yes"; }else{ echo "No"; }; ?></td>							
						</tr>
						<tr>
							<td class="th">Occupation</td>
							<td class="th">:</td>
							<td class="td"><?php echo $sql_data['sc_occupation']; ?></td>							
						</tr>
						<tr>
							<td class="th">Retired</td>
							<td class="th">:</td>
							<td class="td"><?php if($sql_data['is_sc_retired'] == 1){ echo "Yes"; }else{ echo "No"; }; ?></td>							
						</tr>
						<tr>
							<td class="th">Pensioned</td>
							<td class="th">:</td>
							<td class="td"><?php if($sql_data['is_sc_pensioned'] == 1){ echo "Yes"; }else{ echo "No"; }; ?></td>							
						</tr>
						<tr>
