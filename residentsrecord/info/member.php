					...
					<tbody>
						...
						?>
									<tr>
										...
										<td>
											<a href="index.php?view=details_pop&id=<?php echo $mem_data['r_id']; ?>" class="btn btn-warning waves-effect waves-light btn-xs"><i class="fa fa-eye m-l-5"></i> <span>View</span></a>
											&nbsp;
											<a href="index.php?view=modify&id=<?php echo $mem_data['r_id']; ?>" class="btn btn-info waves-effect waves-light btn-xs"><i class="fa fa-edit m-l-5"></i> <span>Edit</span></a>
											&nbsp;
