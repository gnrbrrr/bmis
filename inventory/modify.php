...
<br>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-6">
			<div class="white-box">
				<h3 class="box-title m-b-0" style="color:#663399; font-weight:bold;">Inventory</h3>
				<p class="text-muted m-b-30 font-13"> Modify Inventory Records </p>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Item Name" name="item" autocomplete=off value="<?php echo $sql_data['in_item']; ?>" required /> </div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="date" class="form-control" id="exampleInputuname" placeholder="Date of Purchase" name="datep" autocomplete=off value="<?php echo $sql_data['in_dop']; ?>" /> </div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Total Quantity" name="qty" autocomplete=off value="<?php echo $sql_data['in_qty']; ?>" /> </div>
						</div>
					</div>
					<div class="form-group">
						<label for="exampleInputuname" class="col-sm-3 control-label">Available Quantity</label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Available Quantity" name="avail_qty" autocomplete=off value="<?php echo $sql_data['in_available_qty']; ?>" readonly /> </div>
						</div>
					</div>
