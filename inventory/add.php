	...
	<form class="form-horizontal" method="post" action="process.php?action=add" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-6">
			<div class="white-box">
				...
				<p class="text-muted m-b-30 font-13"> Add Inventory </p>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Item Name" name="item" autocomplete=off required /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								...
								<select name="condition" class="select2" style="width:270px;">
									<option value="Running in Good Condition">Good Condition</option>
