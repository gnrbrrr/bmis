...
<br>
	<div class="row">
	<form class="form-horizontal" method="post" action="process.php?action=modify_summon" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-12">
			<div class="white-box">
			...
			<div class="modal-body">		
				<div class="row">
                                            ...
                                            <div class="row">
												...
												<div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" id="date" class="form-control" name="date" value="<?php echo $summ_data['date_summon']; ?>" required ><br/> 
													</div>
                                                </div>
												<div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="control-label">Time:</label>
                                                        <input type="time" id="time" class="form-control" name="time" value="<?php echo $time_formatted; ?>" required ><br/> 
													</div>
                                                </div>
											</div>
											<div class="row">
					...
					<div class="form-actions">
						<input type="hidden" name="id" value="<?php echo $sm_id; ?>">
						<button type="submit" class="btn btn-success waves-effect waves-light m-r-10"><i class="fa fa-save fa-fw"></i> Save</button>
                    	<button type="button" class="btn btn-inverse waves-effect waves-light" onClick="window.location.href='index.php?view=detail&id=<?php echo $summ_data['lpn_id']?>'">Cancel</button>
                    </div>
                </div>
			</div>
