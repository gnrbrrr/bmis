			...
			<div class="white-box">
				...
				<p class="text-muted m-b-30 font-13"> Modify Blotter Records </p>
					...
					<div class="form-group">
						<label for="exampleInputuname" class="col-sm-3 control-label">Blotter Case Status.</label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<select id="blot_stats" class="blot_stats" name="blot_stats">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Blotter No." name="blotterno" autocomplete=off value="<?php echo $sql_data['blotter_no']; ?>" readonly /> </div>
						</div>
					</div>
