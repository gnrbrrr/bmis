	...
	<form class="form-horizontal" method="post" action="process.php?action=add" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-10">
			<div class="white-box">
				...
				<p class="text-muted m-b-30 font-13"> Add Resolution </p>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Resolution No." name="res_no" autocomplete=off /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<textarea type="text" class="form-control" id="exampleInputuname" placeholder="Title" name="title" style="width:900px; resize:vertical; min-height:75px; max-height:300px;" autocomplete=off ></textarea> </div>
						</div>
					</div>
					<div class="form-group">
