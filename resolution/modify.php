...
if($sql->rowCount() > 0)
{
	...
	$date_approve = date("Y-m-d", strtotime($sql_data['re_date']));
...
<br>
	...
	<form class="form-horizontal" method="post" action="process.php?action=modify" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-6">
			<div class="white-box">
				<h3 class="box-title m-b-0" style="color:#663399; font-weight:bold;">Resolution</h3>
				<p class="text-muted m-b-30 font-13"> Modify Resolution Records </p>
					<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Item Description" name="item_no" autocomplete=off value="<?php echo $sql_data['re_itemno']; ?>" required /> </div>
						</div>
					</div>
					<div class="form-group">
						<label for="exampleInputuname" class="col-sm-3 control-label">Resolution No.</label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Resolution No." name="res_no" autocomplete=off value="<?php echo $sql_data['re_resno']; ?>" /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<textarea class="form-control" id="exampleInputuname" placeholder="Title" name="title" autocomplete=off style="resize:vertical; width:490px; min-height:75px; max-height:300px;" required ><?php echo $sql_data['re_title']; ?></textarea> </div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Date of Purchase" name="remarks" autocomplete=off value="<?php echo $sql_data['re_remarks']; ?>" /> </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><i class="icon-arrow-right"></i></div>
								<input type="text" class="form-control" id="exampleInputuname" placeholder="Committee / Others" name="committee" value="<?php echo $sql_data['re_committee']?>" autocomplete=off /> </div>
						</div>
					</div>
