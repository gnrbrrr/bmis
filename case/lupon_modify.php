		...
		<div class="col-md-12">
			...
			<div class="modal-body">		
				<div class="row">
											...
											<div class="row">
												 <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" id="complaints" class="form-control" placeholder="Ex. complainant1,complainant2,complainant3" name="complaints"><?php echo $sql_data['lpn_complaints'];?></textarea><br/>
													</div>
                                                </div>			
											</div>
											<div class="row">
											...
											<div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" id="respondents" class="form-control" placeholder="Ex. respondent1,respondent2,respondent3" name="respondents"><?php echo $sql_data['lpn_respondents']; ?></textarea><br/>
													</div>
                                                </div>                                               											
											</div>
											<div class="row">
                    ...
                    <button type="button" class="btn btn-inverse waves-effect waves-light" onClick="window.location.href='index.php?view=lupon_list'">Cancel</button>
                    </div>
                </div>
