	...
	<table style="border:solid 0px #000000; width:100%;">						
		<tbody>
			...
			?>
					...
					<tr><td><br /></td></tr>
					<tr>
						<td class="label"><b>Building Details</b></td>
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="text" class="txt_bx" id="exampleInputuname" name="build_det" autocomplete=off required />
						</td>
					</tr>					
					<tr><td><br /></td></tr>
					<tr>
						<td class="label"><b>Building Address</b></td>
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="text" class="txt_bx" id="exampleInputuname" name="build_address" autocomplete=off required />
						</td>
					</tr>					
					<tr><td><br /></td></tr>
					<tr>
