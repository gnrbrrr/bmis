	...
	<table style="border:solid 0px #000000; width:100%;">						
		<tbody>
			...
			?>
					...
					<tr><td><br /></td></tr>
					<tr>								
						<td class="label"><b>Name of Association</b></td>
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="text" class="txt_bx" id="exampleInputuname" name="assoc_name" autocomplete=off required />
						</td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>								
						...
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="text" class="txt_bx" id="exampleInputuname" name="assoc_address" autocomplete=off required />
						</td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>
