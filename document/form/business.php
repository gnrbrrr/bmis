	...
	<table style="border:solid 0px #000000; width:100%;">						
		<tbody>
			...
			?>
				...
				<tr>								
					<td class="label"><b>Business Type</b></td>
					<td class="dot"><b>:</b></td>
					<td class="data"><?php echo $bus_data['btype']; ?></td>
				</tr>
				<tr><td><br /></td></tr>
				...
				<tr>
					<td class="label"><b>Book Number</b></td>
					<td class="dot"><b>:</b></td>
					<td class="data">
						<input type="text" class="txt_bx" id="exampleInputuname" name="bookno" value="<?php echo $bus_data['bookno']; ?>" autocomplete=off readonly />
					</td>
				</tr>
				<tr><td><br /></td></tr>
