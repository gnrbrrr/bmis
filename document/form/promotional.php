	...
	<table style="border:solid 0px #000000; width:100%;">						
		<tbody>
			...
			?>
					...
					<tr><td><br /></td></tr>
					<tr>
						<td class="label"><b>Event</b></td>
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="text" class="txt_bx" id="exampleInputuname" name="event" autocomplete=off required />
						</td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>
						...
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="text" class="txt_bx" id="exampleInputuname" name="event_address" autocomplete=off required />
						</td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>
						...
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="date" class="txt_bx" id="exampleInputuname" name="duration1" autocomplete=off required /> <b> - </b> <input type="date" class="txt_bx" id="exampleInputuname" name="duration2" autocomplete=off required />
						</td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>
						...
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="time" class="txt_bx" id="exampleInputuname" name="time1" autocomplete=off required /> <b> - </b> <input type="time" class="txt_bx" id="exampleInputuname" name="time2" autocomplete=off required />
						</td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>
