		...
		<tbody>
			...
			?>
				...
				<tr>								
					...
					<td class="dot"><b>:</b></td>
					<td class="data"><?php echo $res_data['company_position']; ?></td>
				</tr>
				<tr><td><br /></td></tr>
				<tr>								
					<td class="label"><b>Business Address</b></td>
					<td class="dot"><b>:</b></td>
					<td class="data"><?php echo $res_data['company_address']; ?></td>
				</tr>
				<tr><td><br /></td></tr>
				<tr>								
				...
				<tr><td><br /></td></tr>
				<tr>								
					<td class="label"><b>Birth Place</b></td>
					<td class="dot"><b>:</b></td>
					<td class="data"><?php echo $res_data['birthplace']?></td>
				</tr>
				<tr><td><br /></td></tr>
				<tr>								
				...
				<tr>
					...
					<td class="dot"><b>:</b></td>
					<td class="data">
						<input type="text" class="txt_bx" id="exampleInputuname" name="purpose" value="Working Clearance" autocomplete=off readonly />
					</td>
				</tr>
				<tr><td><br /></td></tr>
				<tr>
					<td class="label"><b>CTC No.</b></td>
					<td class="dot"><b>:</b></td>
					<td class="data">
						<input type="text" class="txt_bx" id="exampleInputuname" name="ctcno" autocomplete=off required />
					</td>
				</tr>
				<tr><td><br /></td></tr>
				<tr>
