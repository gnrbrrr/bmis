		...
		<tbody>			
			...
			?>
					...
					<tr>
						...
						<td class="dot"><b>:</b></td>
						<td class="data"><input type="text" class="txt_bx" id="exampleInputuname" name="position" value="Owner" autocomplete=off readonly /></td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>
					...
					<tr>
						...
						<td class="dot"><b>:</b></td>
						<td class="data">
							<input type="text" class="txt_bx" id="exampleInputuname" name="control" autocomplete=off required />
						</td>
					</tr>
					<tr><td><br /></td></tr>
					<tr>
