					...
					<div class="tab-content" style="border: solid 1px; width:100%;">
						...
						?>
									...
									<div id="<?php echo $sql7_data['cer_id']; ?>" class="tab-pane">
										...
										<br />
											<?php
												if($sql7_data['cer_id'] == '1020' || $sql7_data['cer_id'] == '1024' || $sql7_data['cer_id'] == '1034')
												{
											?>
													...
													&nbsp;
													<input style="width: 200px;" type="submit" value="New Transaction" class="btn btn-success btn_bx" />
													<br /><br />
													<div class="table-responsive" style="overflow-x:scroll; width:86.5%;">				
															...
															<tbody>
																...
																?>
																			<tr>
																				...
																				<td><?php echo $drb_data['oname']; ?></td>
																				<td><?php echo $drb_data['bclass']; ?></td>
																				<td>&#8369;<?php echo number_format($drb_data['amount'], 2); ?></td>
																				<td><?php echo $drb_data['or_num']; ?></td>
																				<td><?php echo $dtissued_b; ?></td>
																				<td>
																					<a href="<?php echo WEB_ROOT; ?>certificate/<?php echo $sql7_data['page']; ?>.php?id=<?php echo $drb_data['uid']; ?>">Print</a>
																					<!--&nbsp;
																					<a href="<?php echo WEB_ROOT; ?>certificate/<?php echo $sql7_data['page_noid']; ?>.php?id=<?php echo $drb_data['uid']; ?>">Without Sig</a>!-->
																				</td>
																			</tr>
																<?php
																		} // End While
											...
											?>
													...
													<input style="width: 200px;" type="submit" value="New Transaction" class="btn btn-success btn_bx" />
													<br /><br />
													<div class="table-responsive" style="overflow-x:scroll; width:80.5%;">				
														<table id="<?php echo $sql7_data['table_id']; ?>" class="display nowrap" style="width:100%;">
															<thead>
																<tr>
																	<th>Book No.</th>
															...
															<tbody>
																...
																?>
																			<tr>
																				<td><?php echo $drb_data['bookno']; ?></td>
																				<td><?php echo $drb_data['businessname']; ?></td>
																				<td><?php echo $drb_data['oname']; ?></td>
																				<td><?php echo $drb_data['bclass']; ?></td>
																				<td>&#8369;<?php echo number_format($drb_data['amount'], 2); ?></td>
											...
											?>
													...
													<div class="table-responsive" style="overflow-x:scroll; width:86.5%;">				
														<table id="<?php echo $sql7_data['table_id']; ?>" class="display nowrap" style="width:100%;">
															...
															<tbody>
																<?php
																	$drb = $conn->prepare("SELECT * FROM tbl_document_request WHERE is_deleted != '1' AND cer_id = '$cerid'");
																	$drb->execute();
																	if($drb->rowCount() > 0)
																	{
																		while($drb_data = $drb->fetch())
																...
																?>
																			<tr>
																				<td><?php echo $drb_data['requestor_name']; ?></td>
																				<td><?php echo $drb_data['purpose']; ?></td>
																				<td><?php echo $drb_data['job_no']; ?></td>
																				<td>&#8369;<?php echo number_format($drb_data['amount'], 2); ?></td>
																				<td><?php echo $drb_data['or_num']; ?></td>
																				<td><?php echo $dtissued_b; ?></td>
																				<td>
																					<a href="<?php echo WEB_ROOT; ?>certificate/<?php echo $sql7_data['page']; ?>.php?id=<?php echo $drb_data['dr_id']; ?>">Print</a>
																					<!--&nbsp;
																					<a href="<?php echo WEB_ROOT; ?>certificate/<?php echo $sql7_data['page_noid']; ?>.php?id=<?php echo $drb_data['dr_id']; ?>">Without Sig</a>!-->
																				</td>
																			</tr>
																<?php
																		} // End While
											...
											?>
													...
													<select name="res" class="select2" id="resident">
														<?php
															...
															<tbody>
																...
																?>
																			<tr>
																				...
																				<td><?php echo $drr_data['purpose']; ?></td>
																				<td>&#8369;<?php echo number_format($drr_data['amount'], 2); ?></td>
																				<td><?php echo $dtissued_r; ?></td>
																				<td>
																					<a href="<?php echo WEB_ROOT; ?>certificate/<?php echo $sql7_data['page']; ?>.php?id=<?php echo $drr_data['uid']; ?>">Print</a>
																					<!--&nbsp;
