   ...
   font-size:13px;
		...
		<tr>		
			<td style="text-align:center;">
				<h3>Vehicle Maintenance Report</h3>
		...
		<tr><td>		
			...
			<tr>
				...
				<td width="20px;">&nbsp;</td>
				<td class="tdlabel">Corrective</td>
				<td width="20px;">&nbsp;</td>
				<td class="tdlabel">Preventive</td>
				<td width="20px;">&nbsp;</td>
				<td class="tdlabel">Predictive</td>
				<td width="20px;">&nbsp;</td>
								  ...
								  <tbody>
									...
									?>
												<tr>
													...
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top"><?php echo $emp_data['odo_beginning']; ?></td>
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top"><?php echo $emp_data['odo_ending']; ?></td>
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top"><?php echo $emp_data['corrective']; ?></td>
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top"><?php echo $emp_data['preventive']; ?></td>
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top"><?php echo $emp_data['predictive']; ?></td>
													<td width="20px;">&nbsp;</td>
													<td class="tddata" valign="top"><?php echo $emp_data['expenses']; ?></td>
													<td width="20px;">&nbsp;</td>
