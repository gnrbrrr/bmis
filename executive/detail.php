...
if (!defined('WEB_ROOT')) {
	...
	$dateappr = date("M d, Y", strtotime($sql_data['ex_date']));
	...
	<form class="form-horizontal" method="post" action="process.php?action=add" enctype="multipart/form-data" name="form" id="form">
		<div class="col-md-6">
			<div class="white-box">
				...
				<p class="text-muted m-b-30 font-13"> View Executive </p>

					<div class="m-l-40"><b class="text-info">Executive Order Image : </b>
					...
					<div class="m-l-40"><b class="text-info">Item No. : </b>
						<p style="padding-left:27px; color:black;"><?php echo $sql_data['ex_itemno']; ?></p>
                    </div>
					
					<div class="m-l-40"><b class="text-info">Executive No. : </b>
						<p style="padding-left:27px; color:black;"><?php echo $sql_data['ex_no']; ?></p>
                    </div>
					
					<div class="m-l-40"><b class="text-info">Title : </b>
						<p style="padding-left:27px; color:black;"><?php echo $sql_data['ex_title']; ?></p>
                    </div>
					...
					<div class="m-l-40"><b class="text-info">Remarks : </b>
						<p style="padding-left:27px; color:black;"><?php echo $sql_data['ex_remarks']; ?></p>
                    </div>

					<div class="m-l-40"><b class="text-info">Committee / Others : </b>
						<p style="padding-left:27px; color:black;"><?php echo $sql_data['ex_committee']; ?></p>
                    </div>
										
					<div class="form-group m-b-0">
						<div class="col-sm-offset-3 col-sm-9">
							<a class="btn btn-success waves-effect waves-light m-r-10" href="index.php?view=modify&id=<?php echo $sql_data['ex_id']; ?>"><i class="fa fa-edit fa-fw"></i> Edit</a>
